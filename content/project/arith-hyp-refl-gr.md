...
-  In other words, a free finitely-generated $A$-module with an inner product of signature $(n,1)$ is said to be $\textbf{a hyperbolic lattice}$, if for each non-identity embedding $\sigma \colon \mathbb{F} \to \mathbb{R}$ the quadratic space $L \otimes_{\sigma(A)} \mathbb{R}$ is positive definite.
...
[Mar17] Alice Mark. The classification of rank 3 reflective hyperbolic lattices over Z( 2). PhD thesis,
University of Texas at Austin, 2015. in preparation.

[MT62] G. Mostow and Tamagawa. 

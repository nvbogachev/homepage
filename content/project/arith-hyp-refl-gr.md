...
## Basic definitions and facts
  ...
  - Such groups $O'(f, \mathbb{O}_{\mathbb{F}})$ are said to be $\textbf{arithmetic lattices of simpliest type}$.

  - Suppose $O_r(f, \mathbb{O}_{\mathbb{F}})$ is the subgroup generated by all reflection in $O'(f, \mathbb{O}_{\mathbb{F}})$. If it is the finite index subgroup of $O'(f, \mathbb{O}_{\mathbb{F}})$, then the form $f(x)$ is called $\textbf{reflective}$. It is equivalent to the fact that the fundamental (Coxeter) polyhedron of the group $O_r(f, \mathbb{O}_{\mathbb{F}})$ has a finite volume in the space $\mathbb{H}^n$.

  - In other words, a free finitely-generated $\mathbb{O}_{\mathbb{F}}$-module with an inner product of signature $(n,1)$ is said to be $\textbf{a hyperbolic lattice}$, if for each non-identity embedding $\sigma \colon \mathbb{F} \to \mathbb{R}$ the quadratic space $L \otimes_{\sigma(\mathbb{O}_{\mathbb{F}})} \mathbb{R}$ is positive definite.

  - Suppose $O'(L)$ is the group of integral automorphisms, preserving the $n$-dimensional Lobachevsky (hyperbolic) space $\mathbb{H^n}$.

  - If the subgroup $O_r(L)$ of $O'(L)$ generated by all reflections is of finite index, then tha lattice $L$ is said to be $\textbf{reflective}$. It is equivalent to the fact that the fundamental (Coxeter) polyhedron of the group $O_r(L)$ has a finite volume in the space $\mathbb{H}^n$.
